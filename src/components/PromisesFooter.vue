    ...
    <div class="col-md-12">
      <div class="credits">
        ...
        <p class="disclaimer small">
          Opravičujemo se za morebitne napake. Za popravke, dodatne informacije
          in medijska vprašanja smo dosegljivi na na
          <a href="mailto:maja@djnd.si" target="_blank">maja@djnd.si</a>.
        </p>
      </div>
    </div>
  </div>
