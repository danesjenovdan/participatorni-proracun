  ...
  <div class="background">
    <div class="row">
      <div id="col_one" class="col-lg-7 col-12 align-self-center">
        <div class="row">
          ...
          <div class="col-7 text-left text align-self-end">
            <span>Občina<br>{{ info.SIMPLE_OBCINA }}<br>
              <span v-if="info['IZVAJA PP'] === '1'" class="izvaja">izvaja</span>
        ...
        <div class="row">
          <div class="col">
            <span><strong>PARTICIPATIVNI<br>PRORAČUN!</strong></span>
          </div>
        </div>
      </div>
      <div id="col_two" class="col-lg-5 col-12 align-self-center">
        <div class="text-left py-5 px-4 text" style="background-color: #f2cc59">
          <img class="candidate_img" :src="getProfilePicPath()" alt="profile_image">
          <img v-if="info['IZVAJA PP'] === '1'" class="icon" src="../assets/happy_face_no_border.svg" alt="happy_face">
          <img v-else class="icon" src="../assets/sad_face_no_border.svg" alt="happy_face">
          <span style="text-align: left">
            ...
            <b v-else>
              ni izpolnil<span v-if="info.SPOL === 'ž'">a</span>
            </b>
...
<script>
  ...
  export default {
    ...
    methods: {
      getProfilePicPath(){
        let img_name = removeDiacritics(this.info.OBČINA)
