...
const stuff = [
  ...
  },
  {
    ...
    a: `
      ...
      <p>Od pričetka trenutnega mandata leta jeseni 2018 se je za izvedbo participativnega proračuna odločilo 38 slovenskih občin: Ajdovščina, Benedikt, Bohinj, Brežice, Črenšovci, Divača, Dol Pri Ljubljani, Domžale, Dravograd, Hrastnik, Hrpelje-Kozina, Izola, Jesenice, Komen, Koper, Kranj, Krško, Laško, Logatec, Lovrenc na Pohorju, Maribor, Medvode, Murska Sobota, Nova Gorica, Postojna, Ptuj, Razkrižje, Ruše, Semič, Sevnica, Slovenjske Konjice, Slovenj Gradec, Sveta Trojica v Slovenskih goricah, Šentilj, Škofja Loka, Šmartno ob Paki, Šoštanj, Tolmin.</p>
    `,
  },
  {
